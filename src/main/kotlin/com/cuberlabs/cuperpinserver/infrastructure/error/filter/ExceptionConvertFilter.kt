package com.cuberlabs.cuperpinserver.infrastructure.error.filter

import com.cuberlabs.cuperpinserver.infrastructure.exception.CuberException
import com.cuberlabs.cuperpinserver.infrastructure.exception.PresentationValidationException
...
class ExceptionConvertFilter : GenericFilterBean() {
    ...
    override fun doFilter(request: ServletRequest, response: ServletResponse, chain: FilterChain) {
        try {
            ...
            throw when (e.cause) {
                is CuberException -> e.cause as CuberException
